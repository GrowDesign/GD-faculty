...
GitHub Plugin URI: https://github.com/GrowDesign/GD-faculty
*/
...
/*
    ...
    */
   add_action( 'admin_init', 'gd_faculty_plugin_admin_init' );
   
   function gd_faculty_plugin_admin_init() {
       /* Register our stylesheet. */
       wp_register_style( 'gd_faculty_style', plugins_url('css/style.css', __FILE__) );
       wp_enqueue_style( 'gd_faculty_style' );
   }
   
   
   

add_action( 'init', 'register_cpt_faculty', 11 );
...
function register_cpt_faculty() {
    ...
    $labels = array( 
        ...
        'add_new_item' => _x( 'Add New Faculty', 'faculty' ),
        'edit_item' => _x( 'Edit Faculty', 'faculty' ),
        'new_item' => _x( 'New Faculty', 'faculty' ),
        'view_item' => _x( 'View Faculty', 'faculty' ),
...
add_action( 'init', 'gd_faculty_setup', 11 );

function gd_faculty_setup(){

require_once( trailingslashit( get_template_directory() ) . "includes/builder/class-et-global-settings.php");
require_once( trailingslashit( get_template_directory() ) . "includes/builder/class-et-builder-element.php");

class GD_Builder_Module_Faculty_Portfolio extends ET_Builder_Module {
	function init() {
		$this->name = __( 'Faculty Portfolio', 'et_builder' );
		$this->slug = 'gd_pb_faculty_portfolio';
		...
		$this->main_css_element = '%%order_class%% .et_pb_portfolio_item .gd_pb_faculty_portfolio_item';
...
new GD_Builder_Module_Faculty_Portfolio;
...
// add_action( 'after_setup_theme', 'gd_faculty_setup', 101 );
